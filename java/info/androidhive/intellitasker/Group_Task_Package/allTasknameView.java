...
public class allTasknameView extends makeRecyclerView {
       ...
       // groupname = b.getString("group");
        ...
        createnewgroupbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(allTasknameView.this,assignTask.class);
                Bundle b = new Bundle();
        ...
        adapter = new allTaskAdapter(this,name,groupname,members);
        recyclerView =
